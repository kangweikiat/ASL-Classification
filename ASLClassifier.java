...
public class ASLClassifier {
    public static void main(String[] args) throws IOException {
        ...
        if (!locationToLoad.exists()) {
            ...
            traintestiter = ModelTraining.DataRetriever();
            ModelTraining.networkmodel(traintestiter);
...
class ModelTraining{
    ...
    public static Pair<DataSetIterator, DataSetIterator>DataRetriever() throws IOException{
        ...
        List<org.nd4j.common.primitives.Pair<ImageTransform, Double>> augList = Arrays.asList(
                new org.nd4j.common.primitives.Pair<>(hFlip, 0.4),
                new org.nd4j.common.primitives.Pair<>(rotate, 0.5),
                new org.nd4j.common.primitives.Pair<>(rCrop, 0.3)
        );
